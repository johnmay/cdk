...
/**
 * An implementation of IAtomMatcher for matching the atom charges
 *
 * @author John May
 * @cdk.module standard
 * @see org.openscience.cdk.isomorphism.UniversalIsomorphismTester
 */
public class ChargeMatcher implements IAtomMatcher {

    /**
     * Matches charges of the query and subject atoms. If both charge values are
     ...
     *
     * @return the atom charges match or are both null
     */
    @Override
    ...
    public String toString() {
        return "query.getCharge() == subject.getCharge()";
    }
