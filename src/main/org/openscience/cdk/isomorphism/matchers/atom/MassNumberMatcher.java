 ...
 */
public class MassNumberMatcher implements IAtomMatcher {
    ...
    public boolean matches(IAtom query, IAtom subject) {
        ...
        Integer queryMass   = query.getMassNumber();
        Integer subjectMass = subject.getMassNumber();

        return queryMass != null ? queryMass.equals(subjectMass) : subjectMass == null;
    ...
    public String toString() {
        return "query.getMassNumber() == subject.getMassNumber()";
    }
