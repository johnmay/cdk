...
public class ConjunctionMatcher implements IAtomMatcher {
    ...
    /**
     * Constructor the matcher with a left and right matcher. The left
     * matcher will be tested first therefore conditions more likely to
     * fail should be put on the left. If the left condition fails the right
    ...
    /**
     * Tests the for a match in the left and right matchers. The matchers
     ...
     *
     * @return true if both left and right matchers are true, false otherwise.
     */
    @Override
