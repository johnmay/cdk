 ...
 * @cdk.module io
 */
public class LargeBondInput extends BondInputMarshal {

    @Override
    public void read(DataInput in, IAtomContainer container, IBond bond) throws IOException {
        bond.setAtom(container.getAtom(readUnsignedShort(in)), 0);
        bond.setAtom(container.getAtom(readUnsignedShort(in)), 1);
    }
}
