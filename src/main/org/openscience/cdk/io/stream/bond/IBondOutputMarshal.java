 ...
 */
public interface IBondOutputMarshal {
     ...
     * set by the setDefault method on the {@see IBondInputMarshal}
     *
     * @param bond
     *
     * @return
     */
    public boolean isDefault(final IAtomContainer container, final IBond bond);
